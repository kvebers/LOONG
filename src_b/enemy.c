...
/*   Updated: 2023/01/05 17:19:50 by kvebers          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	init_enemys_textures(t_data *data)
{
	...
	data->enemy[5] = mlx_load_png("./textures/enemy/enemy_tp6.png");
	data->enemy[6] = mlx_load_png("./textures/enemy/fire1.png");
	data->enemy[7] = mlx_load_png("./textures/enemy/fire2.png");
	data->enemy[8] = mlx_load_png("./textures/enemy/fire3.png");
	data->enemy[9] = mlx_load_png("./textures/enemy/fire4.png");
	data->enemy[10] = mlx_load_png("./textures/enemy/fire5.png");
...
void	check_lose(t_data *data, int x, int y)
{
	if (data->map[y * data->width + x] == '2')
		...
		data->game_state = 3;
	else if (data->map[y * data->width + x] == '3')
		data->game_state = 4;
